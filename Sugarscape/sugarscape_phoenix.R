# Sugarscape replication: Phoenix (from Epstein and Axtell 1996)
...
# If sugar stores fall to at or below zero, agent dies and a new agent with characteristics drawn based on the current distribution of those characteristics is reborn
