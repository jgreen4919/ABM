...
# If the percentage of agents they see standing *multiplied by their initial quality estimate* exceeds their social threshold, they stand.
...
# High quality run with universal cone rule
...
# Low quality run
do.aud(qual = .5, qualvar = .2, qualt = .7, soctvar = .2)
plotStand(title = "Audience Immediately After Performance Ends")
iterate(iterations = 10)
